			...
			<div class="col-lg-8">
				...
				<!-- DataTales Example -->
							<table class="table table-bordered" id="dataTable"
								...
								<thead>
									<tr>
									<th class="sorting sorting_desc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="순번: activate to sort column ascending" style="width: 41px;" aria-sort="descending">순번</th>
										<th width="50%">제목</th>
										<th>작성자</th>
										<th >작성일</th>
										<th>조회수</th>
