		...
		<div class="row">
			...
			<div class="col-lg-8">
				<div class="mb-5">
					...
					<span class="icon-keyboard_arrow_right">&nbsp;<b>일반회원</b> : 1인당 도서관별 10권 15일간(대출일 포함, 연장 불가)</span><br>
					<span class="icon-keyboard_arrow_right">&nbsp;<b>장애인</b> : 1인당 도서관별 10권 30일간(대출일 포함, 연장 불가)</span><br>
					<span class="icon-keyboard_arrow_right">&nbsp;<b>단체대출(순회문고)</b> : 단체(기관별) 200권 이하 60일간(대출일 포함, 1회 30일 연장 가능)</span><br>
				</div>
				<div class="mb-5">
					<h3 class="h4 d-flex align-items-center mb-4 text-primary box">
						<span class="icon-book">&nbsp;</span><span class="half-highlight">관외대출제한</span>
					</h3>
					<span class="icon-keyboard_arrow_right">&nbsp;고서, 귀중자료, 희귀본 등 망실 또는 훼손 우려가 있는 자료</span><br>
					<span class="icon-keyboard_arrow_right">&nbsp;참고자료, 연속(정기)간행물, 비도서자료(DVD, CD-ROM 제외)</span><br>
					<span class="icon-keyboard_arrow_right">&nbsp;공공기관에서 발행하는 일체의 행정자료 및 대구학(大邱學)관련 자료</span><br>
				</div>
				<div class="mb-5">
