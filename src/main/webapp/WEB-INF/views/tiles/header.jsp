		...
		<div class="container-fluid">
			<div class="row align-items-center">
				<div class="site-logo col-6">
					<a href="index.jsp">예담작은도서관</a>
				</div>

				<nav class="mx-auto site-navigation">
					<ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
						<li class="has-children"><a href="bookSerchForm.do">자료이용</a>
							<ul class="dropdown">
						...
						<li class="has-children"><a href="map.do">이용안내</a>
							<ul class="dropdown">
						...
						<li class="has-children"><a href="noticeList.do">열린공간</a>
							<ul class="dropdown">
								<li><a href="noticeList.do">공지사항</a></li>
								<li><a href="boardList.do">묻고답하기</a></li>
							</ul></li>
						<li><a href="seatroom.do">열람실 예약</a></li>
						<li class="has-children"><a href="userLoan.do">나의도서관</a>
							<ul class="dropdown">
				...
				<div
					...
					<c:if test="${loginUserVO.user_Id eq null}">
						<div class="ml-auto">
							<span
								style="color: rgb(25, 24, 24); font-size: 1.1rem; vertical-align: middle;"><i
								class="icon-user"></i>&nbsp;<b>비회원</b> 님&nbsp;&nbsp;</span> <a
								href="userJoinForm.do"
								class="btn btn-outline-black d-none d-lg-inline-block">회원가입</a>
					...
					<c:if test="${loginUserVO.user_Id ne null}">
						<div class="ml-auto">
							<span style="color: rgb(25, 24, 24)"><i class="icon-user"></i>&nbsp;<b>${loginUserVO.user_Name}</b>
								님&nbsp;&nbsp;</span> <a href="userLogOut.do"
								class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span
								class="mr-2 icon-lock_outline"></span>로그아웃</a>
						</div>
					</c:if>
					<a href="#"
