			...
			<div class="col-md-12" align="center">
				...
				<div class="custom-breadcrumbs">
					<a href="home.do">Home</a> <span class="mx-2 slash">/</span> <span
						class="text-white"><strong>희망도서 신청</strong></span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-8">
				<div class="mb-5">
					<h3 class="h4 d-flex align-items-center mb-4 text-primary box">
						<span class="icon-book">&nbsp;</span><span class="half-highlight">희망도서
							신청안내</span>
					</h3>
					<span class="icon-keyboard_arrow_right"></span>&nbsp; <b>신청권수</b> :
					회원 1명당 월 최대 1권까지 신청 가능<br> <span
						class="icon-keyboard_arrow_right"></span>&nbsp; <b>신청장소</b> : 홈페이지
					신청 및 도서관 방문 신청<br> <span class="icon-keyboard_arrow_right"></span>&nbsp;
					<b>대상자료</b> : 도서관에서 소장 중이지 않은 국내 단행본 도서<br> <span
						class="icon-keyboard_arrow_right"></span>&nbsp; <b>세부사항</b>
					<ul>
						<li>비치알림
							<ul>
								<li>홈페이지 공지사항 게시 및 문자통보 (회원가입 시 입력한 번호로 문자 안내드립니다.) <a
									href="userPage.do"><b>내 정보 보기</b></a></li>
								<li>문자통보 받은 날부터 3일간 우선 대출권 부여</li>
								<li>단, 희망도서 비치일에 연체 중이거나 대출정지 중인 경우, 우선대출이 되지 않아 다른 이용자가 먼저
									대출 가능</li>
							</ul>
						</li>
						<li>선정 제외 기준
							<ul>
								...
								<li>출판된 지 3년 이상 된 자료 (당해 연도 포함) 단, 컴퓨터 ·과학·여행 분야는 2년 이상 된
									자료</li>
								...
								<li>신판이 출시된 구판 자료</li>
								<li>대학교재, 문제집, 수험서, 참고서, 교과서, 워크북, 라이팅북, 팝업북, 악보집,
									참고도서(백과사전,사전류 등)</li>
